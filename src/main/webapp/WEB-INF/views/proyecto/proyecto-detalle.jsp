						...
						<div class="col text-right small">
							...
							<div class="rounded-pill btn btn-outline-primary medium pl-3 pr-2 py-0 d-inline-block">
								...
								<div class="hide position-absolute bg-white py-2 pl-3 pr-2 zi-1 rounded-lg border b-gray shadow r-0 mt-1 dropdown-menu dropdown-menu-right text-right">
									...
									<a id="getDrive" onclick="showPickerDialog()" class="d-block no-link semibold main smallest my-2">Gooogle Drive <img class="ml-2" src="/resources/assets/icons/tareas/drive.svg"></a>
								</div>
							</div>
						</div>
					</div>
...
<!-- Component: Detalles -->
    ...
    var developerKey = 'AIzaSyC4Fgm6-jryvQ0UD8yKdQGFcJZccZPvjNA';

    // The Client ID obtained from the Google API Console. Replace with your own Client ID.
    var clientId = "1081018443674-oqlrtf2si5u01vrl03j8mp1bdmm6n4l7.apps.googleusercontent.com"

    // Replace with your own project number from console.developers.google.com.
    // See "Project number" under "IAM & Admin" > "Settings"
    var appId = "1:1081018443674:web:f549798bfe7a852d83bc23";
