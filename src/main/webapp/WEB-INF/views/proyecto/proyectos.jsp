...
<!-- Sidebar Navigation -->
				<nav class="sidenav col-2 h-100vh position-relative">
					...
					<a href="tareas.html" class="sidenav-item no-link d-block position-relative px-3 py-4">
...
<!-- Component: Proyectos -->
					<div class="row">
						<div class="col pt-2">
							<span class="border border-primary border-bottom-0 rounded-top py-2 px-4 medium blue d-inline-block ml-3">Proyectos</span>
						</div>
						<div class="col text-right">
							<span class="rounded-pill btn btn-primary bg-blue medium px-3 d-inline-block" data-toggle="modal" data-target="#modalNuevoProyecto">Nuevo proyecto</span>
						</div>
					</div>
					<div class="row m-0">
						<div class="col p-0 border b-gray rounded-lg">
							<table class="table table-hover">
								<thead class="thead-scroll">
									<tr>
										<th scope="col" class="gray semibold">Nombre del proyecto</th>
										<th scope="col" class="gray semibold">Unidad de negocio</th>
										<th scope="col" class="gray semibold">Fase del proyecto<img class="ml-1" src="/resources/assets/icons/generales/arrange.svg"></th>
										<th scope="col" class="gray semibold">Project Manager<img class="ml-1" src="/resources/assets/icons/generales/arrange.svg"></th>
									</tr>
								</thead>
								...
								<tbody class="tbody-scroll">
									<template v-for="(item , index) in boards">
									     <tr onclick="window.location='../proyecto/proyecto-detalle';">
											...
											<td>
												<div class="position-relative d-inline-block w-30px">
												...
												<span class="medium main">{{item.manager}}</span>
												<img class="float-right pt-2" src="/resources/assets/icons/generales/chev_right.svg">
											</td>
										</tr>
								    </template>
								</tbody>									
...
<!-- Modal: Nuevo Proyecto -->
			...
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content border-0 px-2">
					<div class="modal-header">
						<h5 class="modal-title semibold main" id="modalNuevoProyectoLabel">Nuevo Proyecto</h5>
						...
						<div class="row">
							<div class="col-6">
								<div class="group-form-fieldset smoth mb-3">
									<label class="js-mat-label">Nombre del proyecto</label>
					...
					<div class="modal-footer">
						...
						<span class="btn btn-primary bg-blue rounded-pill" data-dismiss="modal">Crear Proyecto</span>
					</div>
				</div>
			</div>
		</div>
		...
		<script src="/resources/js/proyecto/functionProyecto.js"></script>
