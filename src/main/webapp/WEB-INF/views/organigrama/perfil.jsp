...
<html lang="es">
	<head>
		...
		<title>Total Office | Perfil</title>
	</head>
...
<!-- Header Navigation  -->
					<header class="row">
						...
						<div class="col-6">
							...
							<h1 class="main h3 semibold m-0">Mis Datos </h1>
						</div>
...
<!-- Component: Perfil -->
					<div class="row pt-5">
						<div class="col-8 mx-auto b-gray rounded-lg overflow-auto px-5 py-4">
							...
							<div class="row mb-4">
								<div class="col-4 medium gray">Imagen de perfil</div>
								<div class="col">
									<div class="row">
										<div class="col-3">
											<img class="rounded-circle border border-light shadow" src="/resources/assets/img/test/test_org_1.png">
										</div>
										<span class="col-9 pt-2 pl-0 gray small">Las fotos ayudan a que tus compañeros de equipo te reconozcan.</span>
									</div>
								</div>
							</div>
							<div class="row mb-4">
								<div class="col-4 medium gray">Correo electr&oacute;nico</div>
								<div class="col semibold main">rodrigo.ortiz@totalplay.com.mx</div>
							</div>
							<div class="row mb-4">
								<div class="col-4 medium gray">Departamento o equipo</div>
								<div class="col semibold main">Estrategia digital</div>
							</div>
							<div class="row mb-4 medium gray">
								<div class="col-4">Direcci&oacute;n</div>
								<div class="col semibold main">Sistemas</div>
							</div>
							<div class="row medium gray">
								<div class="col-4">Tel&eacute;fono</div>
								<div class="col semibold main">5537326166</div>
							</div>
						</div>
					</div>
